...
def print_inventory_items(items):
    ...
    for value in items:
        if value == items[-1]:
            stored_items = stored_items + value['name'] + '.\n'
            break
        stored_items = stored_items + value['name'] + ', '
    print('You have ' + stored_items)
...
def mass(inventory):
    totalmass=0
    for everyitem in inventory:
        totalmass = totalmass + everyitem['mass']
        if totalmass>4:
            totalmass = totalmass - everyitem['mass']
            return False
